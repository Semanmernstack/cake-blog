  ...
  return (
    <div>
      <div>
        ...
        <img src={posts.post.coverPhoto.url} alt="pics" />
        <p dangerouslySetInnerHTML={{__html: posts.post.content.html}}></p>
      </div>
      <div>
        <img className="w-7 h-7" src={posts.post.author.avatar.url} alt="avatar" />
        <p>{posts.post.author.avatar.name}</p>
        <p>{posts.post.dataPublishes}</p>
      </div>
